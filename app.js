let game = {
  ...
  playerTwo.fighters.splice(a , 1)
      ...
      for(let b = deaths; b < playerOne.fighters.length;  deaths = deaths - 1){
       console.log(deaths + 'testing loop')
        }
  ...
  function combat() {
    console.log(playerOne.fighters.length)
    for(let a = 0; a < playerOne.fighters.length; a++){
     
      console.log(playerOne.fighters[a].action)
      }
    }
  ...
  buildFighter(playerOne,  'jeff')
  buildFighter(playerOne, 'dylan')
  buildFighter(playerTwo, 'bob')
  
   selectBuild(playerOne, fighter , 'jake')
  
  fighterDefend(playerTwo,'bob')
  
  fighterAttack(playerOne, 'jeff')
  fighterAttack(playerOne, 'dylan')
